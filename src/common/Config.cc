...
//         // cps
//         curele = curele->NextSiblingElement("cps") ;
//         if (!curele) {
//           cout << "wrong configuration for ec.policy!" << endl;
//           exit(1);
//         }
//         int cps = std::stoi(curele->GetText());
//         // locality
...
//           param.push_back(paramtext.substr(start));
//         }
//         ECPolicy* ecpolicy = new ECPolicy(id, classname, n, k, cps, locality, optlevel, param);
// //        ecpolicy->dumpECPolicy();
