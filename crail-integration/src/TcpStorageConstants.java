...
public class TcpStorageConstants {
	...
	public static final String STORAGE_HDD_PORT_KEY = "crail.storage.hdd.port";
	public static int STORAGE_HDD_PORT = 50019;
	...
	public static final String STORAGE_HDD_STORAGE_LIMIT_KEY = "crail.storage.hdd.storagelimit";
	public static long STORAGE_HDD_STORAGE_LIMIT = 1073741824;
	...
	public static final String STORAGE_HDD_DATA_PATH_KEY = "crail.storage.hdd.datapath";
	public static String STORAGE_HDD_DATA_PATH = "/dev/hddtier/data";
	...
	public static void updateConstants(CrailConfiguration conf){
		...
		if (conf.get(STORAGE_HDD_PORT_KEY) != null) {
			STORAGE_HDD_PORT = Integer.parseInt(conf.get(STORAGE_HDD_PORT_KEY));
		}			
		...
		if (conf.get(STORAGE_HDD_STORAGE_LIMIT_KEY) != null) {
			STORAGE_HDD_STORAGE_LIMIT = Long.parseLong(conf.get(STORAGE_HDD_STORAGE_LIMIT_KEY));
		}				
		...
		if (conf.get(STORAGE_HDD_DATA_PATH_KEY) != null) {
			STORAGE_HDD_DATA_PATH = conf.get(STORAGE_HDD_DATA_PATH_KEY);
		}
	...
	public static void printConf(Logger logger) {
		...
		logger.info(STORAGE_HDD_PORT_KEY + " " + STORAGE_HDD_PORT);		
		logger.info(STORAGE_TCP_STORAGE_LIMIT_KEY + " " + STORAGE_TCP_STORAGE_LIMIT);
		logger.info(STORAGE_HDD_STORAGE_LIMIT_KEY + " " + STORAGE_HDD_STORAGE_LIMIT);
		...
		logger.info(STORAGE_HDD_DATA_PATH_KEY + " " + STORAGE_HDD_DATA_PATH);
