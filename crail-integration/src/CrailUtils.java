...
public class CrailUtils {
	...
	public static CrailLocationClass getLocationClass() throws UnknownHostException{
        ...
        return CrailLocationClass.get(ipStr2Int(InetAddress.getLocalHost().getHostAddress()));
	}

    public static CrailLocationClass getLocationClass(String ip) throws UnknownHostException {
        return CrailLocationClass.get(ipStr2Int(ip));
    }
