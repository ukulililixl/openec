...
public class CrailConstants {
    ...
    // XL add for OpenEC
    public static final String OEC_CONTROLLER_ADDR_KEY = "oec.controller.addr";
    public static String OEC_CONTROLLER_ADDR = "127.0.0.1";

    public static final String OEC_LOCAL_ADDR_KEY = "oec.local.addr";
    public static String OEC_LOCAL_ADDR = "127.0.0.1";

    public static final String LINK_OEC_KEY = "link.oec";
    public static boolean LINK_OEC = false;
	...
	public static void updateConstants(CrailConfiguration conf){
        // XL add for openec
        if (conf.get(OEC_CONTROLLER_ADDR_KEY) != null) {
            OEC_CONTROLLER_ADDR = conf.get(CrailConstants.OEC_CONTROLLER_ADDR_KEY);
        }
        if (conf.get(OEC_LOCAL_ADDR_KEY) != null) {
            OEC_LOCAL_ADDR = conf.get(CrailConstants.OEC_LOCAL_ADDR_KEY);
        }
        if (conf.get(LINK_OEC_KEY) != null) {
            LINK_OEC = Boolean.parseBoolean(conf.get(CrailConstants.LINK_OEC_KEY));
        }
		//general
